...
- **NEXT (per CTO priority): larger backlog — (c) staff user-management module (DESIGN SESSION FIRST — multi-role schema question, do not improvise), (d) move-out admin UI (BE endpoint exists, ResidentController:172), N2 rich announcements, N4 ticket media+comments (F-05-gated), TEMP_HIDDEN_DEFERRED, VN user guide, hardening F-04/F-05/SEC-20.
