 ...
 *
 * <p>Creator / last-modifier attribution is captured by Spring Data auditing via
 * {@link AuditableEntity}: {@code createdBy} (overridden to the existing
 * {@code created_by_user_id} column) and {@code updatedBy} hold the actor UUID — no
 * manual assignment in the service layer.
 */
@Getter
@Setter
@NoArgsConstructor
