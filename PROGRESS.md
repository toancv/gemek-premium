...
- **NEXT: N3 P5 — `tickets.is_public` (V15) + list/detail scoping + redacted public view + follow/unfollow endpoints, per design §E (G3 immutable, G8 redaction incl. photos hidden until F-05).** Also pending: CTO smoke-test N1 (resident :81). Then remaining backlog: TEMP_HIDDEN_DEFERRED, VN user guide, hardening F-04/F-05/SEC-20 (deferred).
