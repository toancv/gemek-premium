...
- **NEXT: P5 (all FE: E-4 PUT→POST fix, E-1 unread badge, E-2 body render, resident isRead render) — await CTO checkpoint.** Remaining §G questions: Q4 unreadCount direction, Q6 E-2 variant, Q7 E-4 direction (Q5 E-3 backend resolved by P4).
