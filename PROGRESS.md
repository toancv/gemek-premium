...
**✅ PUSHED 2026-06-11 — i18n + date-format work COMPLETE and on origin/deploy/local (HEAD b6078ba):** pre-push verification all green — ui 65/65, admin + resident tsc+vite builds green, backend full suite 244/244 (Java 21 via backend\mvnw.cmd — plain `mvn` NOT on PATH, use the wrapper).
