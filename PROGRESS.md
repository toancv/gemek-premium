...
- **NEXT (hardening done): (c) staff user-mgmt DESIGN SESSION (incl. TECHNICIAN portal gap), (d) move-out admin UI, N2 (unblocked), N4, TEMP_HIDDEN_DEFERRED, VN user guide.
