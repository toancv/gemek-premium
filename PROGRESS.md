...
- **NEXT: CTO smoke-test N1 (resident :81), then N2/N3 design sessions per `reports/module10-extended-backlog.md`.** Then remaining backlog: TEMP_HIDDEN_DEFERRED, VN user guide, hardening F-04/F-05/SEC-20 (deferred).
