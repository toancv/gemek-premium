...
- **NEXT: N3 P2 — `notification_subscriptions` table (V14) + entity/repo + SubscriptionService + backfill, per design §B/§F.** Also pending: CTO smoke-test N1 (resident :81). Then remaining backlog: TEMP_HIDDEN_DEFERRED, VN user guide, hardening F-04/F-05/SEC-20 (deferred).
