...
- **Last completed:** 2026-06-05 — Apartment create form block dropdown switched to async SearchableSelect (loadOptions → GET /api/blocks?size=10&sort=name&direction=asc, debounced 300ms). useBlocks (size=200) kept for page-level block filter select; blocksLoading/blockOptions removed. nginx rebuilt.
